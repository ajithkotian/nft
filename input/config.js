/*******************************************************************
 * NFT collection configurations used while generating the digital art upload to Moralis
 * - Navigate to the BEGIN COLLECTION CONFIG section to provide the config values
 ******************************************************************/
const fs = require("fs");
const dir = __dirname;

// Traverse through the directory where files are placed and return name and path.
// Name will be without the file extension
...
// Adds a layer to the art configuration.
// The layer will hold information on all the defined parts and where they should be rendered in the image
// @param _id - id of the layer
// @param _position - on which position value to render this part
...
// Method to add a rarity to the configuration. 
// A directory with the rarity definition is expected for each defined layer
...
// Method to remove the file extension from the file name. Ex: remove .png from the name
